...
class FireflyProblem():
    ...
    def run(self):
        ...
        def animate(i): #Generate animation and visualization
            ...
            fig.suptitle('Iteration %s/%s' %(i, self.iteration_number))
            self.best = None
            ...
            return particles, rectangle        
        graph = animation.FuncAnimation(fig, animate, frames=self.iteration_number+1, interval=self.interval, blit=True, init_func=init, repeat=False)
...
run_algorithm(shubert,50,3,-3,0.9,2.2,0.9, 50,50)
run_algorithm(ackley,50,3,-3,0.9,2.2,0.9,50,50)
run_algorithm(rosenbrock,50,3,-3,0.9,2.2,0.9,50,50)
run_algorithm(dejong,50,3,-3,0.9,2.2,0.9,50,50)
run_algorithm(griewank,50,3,-3,0.9,2.2,0.9,50,50)
run_algorithm(yang,50,3,-3,0.9,2.2,0.9,50,50)
run_algorithm(rastrigin,50,3,-3,0.9,2.2,0.9,50,50)
run_algorithm(easom,50,3,-3,0.9,2.2,0.9,50,50)
run_algorithm(michalewicz,50,3,-3,0.9,2.2,0.9,50,50)
# run_algorithm(schwefel,50,50,-50,15,20,9,150,50)
